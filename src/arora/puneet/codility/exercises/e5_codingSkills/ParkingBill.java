 ...
 * 
 */
package arora.puneet.codility.exercises.e5_codingSkills;
...
public class ParkingBill {
	...
	public static int solution(String E, String L) {
		...
		int totalBillableHours=totalBillableHours(difference);
		
		totalCost=2+3+((totalBillableHours-1)*4);
		
		return totalCost;
		
    }
	
	public static int totalBillableHours(Long durationInMillis) {
		
		int diffMinutes = (int)(long)(durationInMillis / (60 * 1000) % 60);
		int diffHours = (int)(long)durationInMillis / (60 * 60 * 1000) % 24;
